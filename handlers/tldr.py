...
from handlers.ai import _animated_placeholder, _fail_placeholder
...
_TLDR_PLACEHOLDER = (
    "📜 Бельмондо листает историю чата… _составляю сводку._",
    "📜 Перечитываю реплики между делом… _ищу сюжет._",
    "📜 Отмечаю важные ремарки на полях… _ещё немного._",
    "📜 Складываю переписку в связный рассказ… _почти готово._",
)
    ...
    async with lock:
        ...
        async with _animated_placeholder(
            ...
            try:
                ...
                logger.exception(
                    "tldr: Telethon history fetch failed chat_id=%s", chat_id
                )
