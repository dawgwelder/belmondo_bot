        ...
        *(
        ...
        ),
        {
            ...
            "text": (
                ...
                f"Окно: ~{lifetime_minutes} мин."
                if is_cooperative
                else "Удержите лидерство 30 секунд. Перехваты: 25, 20, 15, 10 и 5 секунд. "
                "Всего 6 ходов; нельзя перехватить у себя. Приз растёт каждый ход "
                "и достаётся последнему лидеру. "
                f"Окно: ~{lifetime_minutes} мин."
                if is_chase
