...
инвентарём, рейтингом, сюжетом и учреждением собственной службы. Обычные
...
проверяет три независимых канала:

- **peak**: score не ниже 6 и минимум четыре принятых сообщения в текущем tick;
- **inertia**: score не ниже 6, с последней активности прошло не больше двух
  минут, вероятность срабатывания 1/3 на tick;
- **random**: редкий фоновый сигнал со средним интервалом около шести часов.
...
Score имеет half-life 30 минут. Все три канала используют общий 12-минутный cooldown,
а после публикации остаётся 45% накопленной активности, поэтому события не
появляются серией. Первые три разных пользователя
