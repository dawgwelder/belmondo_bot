    ...
    def _if(msg: str, 
        ...
        if put_answer:
            ...
            if use_prob:
                ...
                if msg == msg[:-use_end]:
                    _prob = roll_probabilty(.9)
            else:
                _prob = roll_probability((prob_dict[trigger_type]))
            if text is None:
